...
#define HEATER_STATE_Pin GPIO_PIN_1
#define HEATER_STATE_GPIO_Port GPIOD
...
#define HEATER_TANK_STATE_Pin GPIO_PIN_6
#define HEATER_TANK_STATE_GPIO_Port GPIOB
#define SOLENOID_VALVE_STATE_Pin GPIO_PIN_7
#define SOLENOID_VALVE_STATE_GPIO_Port GPIOB
